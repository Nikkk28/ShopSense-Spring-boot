...
//
//import com.shopsense.service.JasperService;
//
...
//		try {
//			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(jasperService.getAdminSalesReportGroupBySeller(startDate, endDate), false);
...
//		try {
//			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(jasperService.getProductDetailsReport(), false);
//			Map<String, Object> param = new HashMap<>();
//			JasperReport compileReport = JasperCompileManager
...
//		try {
//			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(jasperService.getFavoriteItemReport(), false);
//			Map<String, Object> param = new HashMap<>();
//			JasperReport compileReport = JasperCompileManager
...
//		try {
//			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(jasperService.getCustomerReport(), false);
//			Map<String, Object> param = new HashMap<>();
//			JasperReport compileReport = JasperCompileManager
...
//		try {
//			List<HashMap<String, String>> l = jasperService.getAdminProfitReport();
//			double totalSale = 0;
...
//		try {
//			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(jasperService.getSellerReport(), false);
//			Map<String, Object> param = new HashMap<>();
//			JasperReport compileReport = JasperCompileManager
...
//		try {
//			HashMap<String, Object> m = jasperService.getCustomerOrderById(id);
...
//		try {
//			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(jasperService.getStockAlertReport(id), false);
//			Map<String, Object> param = new HashMap<>();
//			JasperReport compileReport = JasperCompileManager
...
//		try {
//			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(jasperService.getTopSellingReport(id), false);
//			Map<String, Object> param = new HashMap<>();
//			JasperReport compileReport = JasperCompileManager
...
//		try {
//			HashMap<String, Object> m = jasperService.getInvoiceByOrderId(id);
//			@SuppressWarnings("unchecked")
